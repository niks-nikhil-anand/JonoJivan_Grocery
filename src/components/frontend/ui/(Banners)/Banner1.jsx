...
>
  ...
  >
    ...
    {/* Product categories grid - Horizontal scroll on smaller screens */}
    <div className="flex space-x-6 overflow-x-auto sm:grid sm:grid-cols-2 lg:grid-cols-4 gap-6 scrollbar-hide">
      {/* Luxury Watches */}
      <div className="min-w-[80%] sm:min-w-0 bg-white bg-opacity-20 backdrop-blur-md rounded-lg p-4">
