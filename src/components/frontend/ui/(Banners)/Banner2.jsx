...
import banner from '../../../../../public/frontend/Banner/footerBanner.png';

const Banner2 = () => {
  return (
    <section className="relative flex flex-col lg:flex-row items-center justify-between  bg-gradient-to-r from-green-500 via-green-400 to-green-300 shadow-2xl overflow-hidden">
      {/* Text and App Store Buttons Section */}
      <div className="relative z-10 text-center lg:text-left lg:w-1/2 space-y-6 p-4">
        <motion.h2
      ...
      {/* Image Section */}
      <motion.div
        className="lg:w-1/2 flex justify-center lg:justify-end mt-0 lg:mt-2 relative"
      ...
      >
        <Image
          ...
          width={600}
          height={600}
          className="absolute lg:relative lg:bottom-0 transform transition-all hover:scale-105 lg:border-b-0 lg:mb-0"
